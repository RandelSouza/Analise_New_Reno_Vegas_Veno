...
* Todo o tutorial para conhecer, baixar, testar e várias outras informações a respeito do NS-3 podem-ser encontradas no seguinte endereço: https://www.nsnam.org/docs/release/3.30/tutorial-pt-br/html/introduction.html. A seguir são descritos os passos para instalação do NS-3 para este trabalho, caso haja alguma dúvida consulte o link anteriormente citado para maiores informações.
...
Através da leitura desta wifi foi criado um script para automatizar a instalação das dependências que são pre requisito para a instalação do ns-3 e também de outras dependências complementares que foram consideradas importantes.
